    ...
    return (
        <div>
            <div style={styles.parentView}>
                ...
                <Dialog open={openNewChat} onClose={handleNewChatClose} aria-describedby="alert-dialog-slide-description">
                    <DialogTitle>Please choose a chat name 🥷🏼</DialogTitle>
                    <DialogContent>
                ...
                <Dialog open={openSetName} onClose={handleSetNameClose}  fullWidth={true} style={{backgroundColor:"black", borderRadius: 0}}>
                    <DialogTitle>Please choose a chat name 🥷🏼</DialogTitle>
                    <DialogContent>
                        <DialogContentText>
                            Be creative🦊, but private🤫
                        </DialogContentText>
                        <TextField
                            autoFocus
                            margin="dense"
                            id="name"
                            label="e.g kinkyskinky23"
                            fullWidth
                            variant="standard"
                    ...
                    <DialogActions style={{backgroundColor: "black"}}>
                        <Button style={{width: "100%", heigh: 400, color: "white", fontWeight:"bold", backgroundColor: "black"}}onClick={handleSetNameClose}>Sign in</Button>
                    </DialogActions>
                </Dialog>
