...
const WebChatListItem = ({ item, position, onItemClick }) => {
  ...
  return (
    <div style={{ cursor: 'pointer', borderColor: "#444", borderWidth: 3, backgroundColor:"#444" }} onClick={() => onItemClick(item)}>
      {position > 0 && (
        <div
          light={true}
      ...
      >
        <ListItemAvatar style={{ flex: 0.15, marginLeft: "0%" }}>
          {/* <chatImage /> */}
        ...
        >
          <ListItemText
            primary={
              <Typography style={{color: "white"}} className={classes.userName}>
                {item}
              </Typography>
            }
          />
